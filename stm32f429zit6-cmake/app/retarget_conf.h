...
#define RETARGET_USART_GPIO_CLK_ENABLE() LL_AHB1_GRP1_EnableClock(LL_AHB1_GRP1_PERIPH_GPIOA) /* Enable the peripheral clock of GPIOA */
#define RETARGET_USART_TX_PIN LL_GPIO_PIN_9
#define RETARGET_USART_TX_GPIO_PORT GPIOA
#define RETARGET_USART_SET_TX_GPIO_AF() LL_GPIO_SetAFPin_8_15(GPIOA, LL_GPIO_PIN_9, LL_GPIO_AF_7)
#define RETARGET_USART_RX_PIN LL_GPIO_PIN_10
#define RETARGET_USART_RX_GPIO_PORT GPIOA
#define RETARGET_USART_SET_RX_GPIO_AF() LL_GPIO_SetAFPin_8_15(GPIOA, LL_GPIO_PIN_10, LL_GPIO_AF_7)
